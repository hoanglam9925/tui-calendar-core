...
declare const StoreProvider: ({ children, store, }: import("../types/components/common").PropsWithChildren<{
    store: import("../types/store").InternalStoreAPI<CalendarStore>;
}>) => import("preact").VNode<{
    value: import("../types/store").InternalStoreAPI<CalendarStore> | null;
    children?: import("preact").ComponentChildren;
}>, useStore: <StateSlice>(selector: import("../types/store").StateSelector<CalendarStore, StateSlice>, equalityFn?: import("../types/store").EqualityChecker<StateSlice>) => StateSlice, useInternalStore: () => import("../types/store").InternalStoreAPI<CalendarStore>;
