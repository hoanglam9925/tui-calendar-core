...
/* harmony import */ var preact_compat__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! preact/compat */ "../../node_modules/preact/compat/dist/compat.module.js");
...
/* harmony import */ var _src_components_popup_eventDetailSectionHeader__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! @src/components/popup/eventDetailSectionHeader */ "./src/components/popup/eventDetailSectionHeader.tsx");
...
/* harmony import */ var _src_constants_popup__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @src/constants/popup */ "./src/constants/popup.ts");
/* harmony import */ var _src_contexts_calendarStore__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @src/contexts/calendarStore */ "./src/contexts/calendarStore.ts");
/* harmony import */ var _src_contexts_eventBus__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @src/contexts/eventBus */ "./src/contexts/eventBus.tsx");
/* harmony import */ var _src_contexts_floatingLayer__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @src/contexts/floatingLayer */ "./src/contexts/floatingLayer.tsx");
/* harmony import */ var _src_contexts_layoutContainer__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @src/contexts/layoutContainer */ "./src/contexts/layoutContainer.tsx");
/* harmony import */ var _src_helpers_css__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @src/helpers/css */ "./src/helpers/css.ts");
/* harmony import */ var _src_helpers_popup__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @src/helpers/popup */ "./src/helpers/popup.ts");
...
/* harmony import */ var _src_selectors__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @src/selectors */ "./src/selectors/index.ts");
/* harmony import */ var _src_selectors_popup__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @src/selectors/popup */ "./src/selectors/popup.ts");
/* harmony import */ var _src_time_date__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @src/time/date */ "./src/time/date.ts");
/* harmony import */ var _src_utils_type__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! @src/utils/type */ "./src/utils/type.ts");
...
var classNames = {
  popupContainer: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_13__.cls)('popup-container'),
  detailContainer: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_13__.cls)('detail-container'),
  topLine: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_13__.cls)('popup-top-line'),
  border: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_13__.cls)('popup-arrow-border'),
  fill: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_13__.cls)('popup-arrow-fill'),
  sectionButton: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_13__.cls)('popup-section', 'section-button'),
  content: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_13__.cls)('content'),
  editIcon: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_13__.cls)('icon', 'ic-edit'),
  deleteIcon: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_13__.cls)('icon', 'ic-delete'),
  editButton: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_13__.cls)('edit-button'),
  deleteButton: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_13__.cls)('delete-button'),
  verticalLine: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_13__.cls)('vertical-line')
};
...
function calculatePopupPosition(eventRect, layoutRect, popupRect) {
  ...
  if ((0,_src_helpers_popup__WEBPACK_IMPORTED_MODULE_14__.isTopOutOfLayout)(top, layoutRect, popupRect)) {
    top = layoutRect.top + layoutRect.height - popupRect.height;
  }

  if ((0,_src_helpers_popup__WEBPACK_IMPORTED_MODULE_14__.isLeftOutOfLayout)(left, layoutRect, popupRect)) {
...
function calculatePopupArrowPosition(eventRect, layoutRect, popupRect) {
  ...
  var direction = isOutOfLayout ? _src_constants_popup__WEBPACK_IMPORTED_MODULE_15__.DetailPopupArrowDirection.right : _src_constants_popup__WEBPACK_IMPORTED_MODULE_15__.DetailPopupArrowDirection.left;
  return {
    top: top,
    direction: direction
  };
...
function EventDetailPopup() {
  var _useStore = (0,_src_contexts_calendarStore__WEBPACK_IMPORTED_MODULE_16__.useStore)(_src_selectors__WEBPACK_IMPORTED_MODULE_17__.optionsSelector),
      useFormPopup = _useStore.useFormPopup;

  var popupParams = (0,_src_contexts_calendarStore__WEBPACK_IMPORTED_MODULE_16__.useStore)(_src_selectors_popup__WEBPACK_IMPORTED_MODULE_18__.eventDetailPopupParamSelector);

  var _ref = popupParams !== null && popupParams !== void 0 ? popupParams : {},
      event = _ref.event,
      eventRect = _ref.eventRect;

  var _useDispatch = (0,_src_contexts_calendarStore__WEBPACK_IMPORTED_MODULE_16__.useDispatch)('popup'),
      showFormPopup = _useDispatch.showFormPopup,
      hideDetailPopup = _useDispatch.hideDetailPopup;

  var calendarColor = (0,_src_hooks_calendar_useCalendarColor__WEBPACK_IMPORTED_MODULE_19__.useCalendarColor)(event);
  var layoutContainer = (0,_src_contexts_layoutContainer__WEBPACK_IMPORTED_MODULE_20__.useLayoutContainer)();
  var detailPopupSlot = (0,_src_contexts_floatingLayer__WEBPACK_IMPORTED_MODULE_21__.useFloatingLayer)('detailPopupSlot');
  var eventBus = (0,_src_contexts_eventBus__WEBPACK_IMPORTED_MODULE_22__.useEventBus)();
  var popupContainerRef = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_12__.useRef)(null);

  var _useState = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_12__.useState)({}),
      _useState2 = _slicedToArray(_useState, 2),
      style = _useState2[0],
      setStyle = _useState2[1];

  var _useState3 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_12__.useState)(0),
      _useState4 = _slicedToArray(_useState3, 2),
      arrowTop = _useState4[0],
      setArrowTop = _useState4[1];

  var _useState5 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_12__.useState)(_src_constants_popup__WEBPACK_IMPORTED_MODULE_15__.DetailPopupArrowDirection.left),
      _useState6 = _slicedToArray(_useState5, 2),
      arrowDirection = _useState6[0],
      setArrowDirection = _useState6[1];

  var popupArrowClassName = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_12__.useMemo)(function () {
    var right = arrowDirection === _src_constants_popup__WEBPACK_IMPORTED_MODULE_15__.DetailPopupArrowDirection.right;
    var left = arrowDirection === _src_constants_popup__WEBPACK_IMPORTED_MODULE_15__.DetailPopupArrowDirection.left;
    return (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_13__.cls)('popup-arrow', {
      right: right,
      left: left
    });
  }, [arrowDirection]);
  (0,preact_hooks__WEBPACK_IMPORTED_MODULE_12__.useLayoutEffect)(function () {
    if (popupContainerRef.current && eventRect && layoutContainer) {
      ...
      setArrowTop(arrowTopPosition - top - _src_constants_popup__WEBPACK_IMPORTED_MODULE_15__.HALF_OF_POPUP_ARROW_HEIGHT);
      setArrowDirection(direction);
    }
  }, [eventRect, layoutContainer]);

  if ((0,_src_utils_type__WEBPACK_IMPORTED_MODULE_23__.isNil)(event) || (0,_src_utils_type__WEBPACK_IMPORTED_MODULE_23__.isNil)(eventRect) || (0,_src_utils_type__WEBPACK_IMPORTED_MODULE_23__.isNil)(detailPopupSlot)) {
    return null;
  }
  ...
  var _event$title = event.title,
      ...
      start = _event$start === void 0 ? new _src_time_date__WEBPACK_IMPORTED_MODULE_24__["default"]() : _event$start,
      _event$end = event.end,
      end = _event$end === void 0 ? new _src_time_date__WEBPACK_IMPORTED_MODULE_24__["default"]() : _event$end,
  ...
  return (0,preact_compat__WEBPACK_IMPORTED_MODULE_11__.createPortal)( // <div>ádsadasdasdasd</div>,
  (0,preact__WEBPACK_IMPORTED_MODULE_10__.h)("div", {
    role: "dialog",
  ...
  }, (0,preact__WEBPACK_IMPORTED_MODULE_10__.h)(_src_components_popup_eventDetailSectionHeader__WEBPACK_IMPORTED_MODULE_25__.EventDetailSectionHeader, {
    event: event
  }), (0,preact__WEBPACK_IMPORTED_MODULE_10__.h)(_src_components_popup_eventDetailSectionDetail__WEBPACK_IMPORTED_MODULE_26__.EventDetailSectionDetail, {
    event: event
  }), !isReadOnly && (0,preact__WEBPACK_IMPORTED_MODULE_10__.h)("div", {
    className: classNames.sectionButton
  }, (0,preact__WEBPACK_IMPORTED_MODULE_10__.h)("button", {
    type: "button",
    className: classNames.editButton,
    onClick: onClickEditButton
  }, (0,preact__WEBPACK_IMPORTED_MODULE_10__.h)("span", {
    className: classNames.editIcon
  }), (0,preact__WEBPACK_IMPORTED_MODULE_10__.h)("span", {
    className: classNames.content
  }, (0,preact__WEBPACK_IMPORTED_MODULE_10__.h)(_src_components_template__WEBPACK_IMPORTED_MODULE_27__.Template, {
    template: "popupEdit",
    as: "span"
  }))), (0,preact__WEBPACK_IMPORTED_MODULE_10__.h)("div", {
...
//# sourceMappingURL=main.fffea2d153727455e82e.hot-update.js.map