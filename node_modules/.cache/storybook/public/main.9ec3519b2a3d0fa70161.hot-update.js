...
/* harmony import */ var _src_constants_popup__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @src/constants/popup */ "./src/constants/popup.ts");
...
/* harmony import */ var _src_contexts_eventBus__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @src/contexts/eventBus */ "./src/contexts/eventBus.tsx");
/* harmony import */ var _src_contexts_floatingLayer__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @src/contexts/floatingLayer */ "./src/contexts/floatingLayer.tsx");
/* harmony import */ var _src_contexts_layoutContainer__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @src/contexts/layoutContainer */ "./src/contexts/layoutContainer.tsx");
/* harmony import */ var _src_helpers_css__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @src/helpers/css */ "./src/helpers/css.ts");
/* harmony import */ var _src_helpers_popup__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @src/helpers/popup */ "./src/helpers/popup.ts");
/* harmony import */ var _src_hooks_calendar_useCalendarColor__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @src/hooks/calendar/useCalendarColor */ "./src/hooks/calendar/useCalendarColor.ts");
/* harmony import */ var _src_selectors__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @src/selectors */ "./src/selectors/index.ts");
/* harmony import */ var _src_selectors_popup__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @src/selectors/popup */ "./src/selectors/popup.ts");
/* harmony import */ var _src_time_date__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! @src/time/date */ "./src/time/date.ts");
/* harmony import */ var _src_utils_type__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @src/utils/type */ "./src/utils/type.ts");
...
var classNames = {
  popupContainer: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_12__.cls)('popup-container'),
  detailContainer: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_12__.cls)('detail-container'),
  topLine: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_12__.cls)('popup-top-line'),
  border: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_12__.cls)('popup-arrow-border'),
  fill: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_12__.cls)('popup-arrow-fill'),
  sectionButton: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_12__.cls)('popup-section', 'section-button'),
  content: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_12__.cls)('content'),
  editIcon: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_12__.cls)('icon', 'ic-edit'),
  deleteIcon: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_12__.cls)('icon', 'ic-delete'),
  editButton: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_12__.cls)('edit-button'),
  deleteButton: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_12__.cls)('delete-button'),
  verticalLine: (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_12__.cls)('vertical-line')
};
...
function calculatePopupPosition(eventRect, layoutRect, popupRect) {
  ...
  if ((0,_src_helpers_popup__WEBPACK_IMPORTED_MODULE_13__.isTopOutOfLayout)(top, layoutRect, popupRect)) {
    top = layoutRect.top + layoutRect.height - popupRect.height;
  }

  if ((0,_src_helpers_popup__WEBPACK_IMPORTED_MODULE_13__.isLeftOutOfLayout)(left, layoutRect, popupRect)) {
...
function calculatePopupArrowPosition(eventRect, layoutRect, popupRect) {
  ...
  var direction = isOutOfLayout ? _src_constants_popup__WEBPACK_IMPORTED_MODULE_14__.DetailPopupArrowDirection.right : _src_constants_popup__WEBPACK_IMPORTED_MODULE_14__.DetailPopupArrowDirection.left;
  return {
    top: top,
    direction: direction
  };
...
function EventDetailPopup() {
  var _useStore = (0,_src_contexts_calendarStore__WEBPACK_IMPORTED_MODULE_15__.useStore)(_src_selectors__WEBPACK_IMPORTED_MODULE_16__.optionsSelector),
      useFormPopup = _useStore.useFormPopup;

  var popupParams = (0,_src_contexts_calendarStore__WEBPACK_IMPORTED_MODULE_15__.useStore)(_src_selectors_popup__WEBPACK_IMPORTED_MODULE_17__.eventDetailPopupParamSelector);

  var _ref = popupParams !== null && popupParams !== void 0 ? popupParams : {},
      event = _ref.event,
      eventRect = _ref.eventRect;

  var _useDispatch = (0,_src_contexts_calendarStore__WEBPACK_IMPORTED_MODULE_15__.useDispatch)('popup'),
      showFormPopup = _useDispatch.showFormPopup,
      hideDetailPopup = _useDispatch.hideDetailPopup;

  var calendarColor = (0,_src_hooks_calendar_useCalendarColor__WEBPACK_IMPORTED_MODULE_18__.useCalendarColor)(event);
  var layoutContainer = (0,_src_contexts_layoutContainer__WEBPACK_IMPORTED_MODULE_19__.useLayoutContainer)();
  var detailPopupSlot = (0,_src_contexts_floatingLayer__WEBPACK_IMPORTED_MODULE_20__.useFloatingLayer)('detailPopupSlot');
  var eventBus = (0,_src_contexts_eventBus__WEBPACK_IMPORTED_MODULE_21__.useEventBus)();
  var popupContainerRef = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_11__.useRef)(null);

  var _useState = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_11__.useState)({}),
      _useState2 = _slicedToArray(_useState, 2),
      style = _useState2[0],
      setStyle = _useState2[1];

  var _useState3 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_11__.useState)(0),
      _useState4 = _slicedToArray(_useState3, 2),
      arrowTop = _useState4[0],
      setArrowTop = _useState4[1];

  var _useState5 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_11__.useState)(_src_constants_popup__WEBPACK_IMPORTED_MODULE_14__.DetailPopupArrowDirection.left),
      _useState6 = _slicedToArray(_useState5, 2),
      arrowDirection = _useState6[0],
      setArrowDirection = _useState6[1];

  var popupArrowClassName = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_11__.useMemo)(function () {
    var right = arrowDirection === _src_constants_popup__WEBPACK_IMPORTED_MODULE_14__.DetailPopupArrowDirection.right;
    var left = arrowDirection === _src_constants_popup__WEBPACK_IMPORTED_MODULE_14__.DetailPopupArrowDirection.left;
    return (0,_src_helpers_css__WEBPACK_IMPORTED_MODULE_12__.cls)('popup-arrow', {
      right: right,
      left: left
    });
  }, [arrowDirection]);
  (0,preact_hooks__WEBPACK_IMPORTED_MODULE_11__.useLayoutEffect)(function () {
    if (popupContainerRef.current && eventRect && layoutContainer) {
      ...
      setArrowTop(arrowTopPosition - top - _src_constants_popup__WEBPACK_IMPORTED_MODULE_14__.HALF_OF_POPUP_ARROW_HEIGHT);
      setArrowDirection(direction);
    }
  }, [eventRect, layoutContainer]);

  if ((0,_src_utils_type__WEBPACK_IMPORTED_MODULE_22__.isNil)(event) || (0,_src_utils_type__WEBPACK_IMPORTED_MODULE_22__.isNil)(eventRect) || (0,_src_utils_type__WEBPACK_IMPORTED_MODULE_22__.isNil)(detailPopupSlot)) {
    return null;
  }
  ...
  var _event$title = event.title,
      ...
      start = _event$start === void 0 ? new _src_time_date__WEBPACK_IMPORTED_MODULE_23__["default"]() : _event$start,
      _event$end = event.end,
      end = _event$end === void 0 ? new _src_time_date__WEBPACK_IMPORTED_MODULE_23__["default"]() : _event$end,
  ...
  return (0,preact_compat__WEBPACK_IMPORTED_MODULE_10__.createPortal)( // <div>ádsadasdasdasd</div>,
...
//# sourceMappingURL=main.9ec3519b2a3d0fa70161.hot-update.js.map